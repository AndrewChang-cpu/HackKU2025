...
export default function Frequency() {
  ...
  // Restore passed data
  const initialFrequency = params.frequencyDetails
    ? JSON.parse(String(params.frequencyDetails))
    : null;
  const name = params.name ? String(params.name) : "";
  const dosage = params.dosage ? String(params.dosage) : "";
  ...
  const handleDone = () => {
    ...
    router.push({
      ...
      params: {
        ...
        dosage,
        description,
        frequencyDetails: JSON.stringify(data),
      },
    });
  };
